(function (jQuery) {
  ...
  $(document).ready(function () {
    var e; var t; var a; var n; var o = 1
    var r = $('fieldset').length
    ...
    t.hide(), e.click(function (a) {
      ...
      var t = e.attr('id')
      var a = $('div.setup-panel div a[href="#' + t + '"]').parent().next().children('a')
      var n = e.find("input[type='text'],input[type='email'],input[type='password'],input[type='url'],textarea")
      var o = !0
    ...
    $('.progress-round').each(function () {
      ...
      var a = $(this).find('.progress-left .progress-bar')
      var n = $(this).find('.progress-right .progress-bar')
