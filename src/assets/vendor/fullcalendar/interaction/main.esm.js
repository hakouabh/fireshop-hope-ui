    ...
    _this.onPointerMove = function (ev) {
      if (_this.isInteracting) { // if false, still waiting for previous drag's revert
        ...
        if (!_this.isDistanceSurpassed) {
          ...
          var deltaX = ev.deltaX; var deltaY = ev.deltaY
...
var HitDragging = /** @class */ (function () {
  ...
  HitDragging.prototype.queryHitForOffset = function (offsetLeft, offsetTop) {
    var _a = this; var droppableStore = _a.droppableStore; var offsetTrackers = _a.offsetTrackers
    var bestHit = null
  ...
  function DateClicking (settings) {
    ...
    _this.handleDragEnd = function (ev) {
      ...
      if (!pointer.wasTouchScroll) {
        var _a = _this.hitDragging; var initialHit = _a.initialHit; var finalHit = _a.finalHit
...
var DateSelecting = /** @class */ (function (_super) {
  ...
  function DateSelecting (settings) {
    ...
    _this.handlePointerDown = function (ev) {
      var _a = _this; var component = _a.component; var dragging = _a.dragging
  ...
  function EventDragging (settings) {
    ...
    _this.handleDragEnd = function (ev) {
      if (_this.isDragging) {
        ...
        var _a = _this; var receivingCalendar = _a.receivingCalendar; var validMutation = _a.validMutation
...
var UnselectAuto = /** @class */ (function () {
  function UnselectAuto (calendar) {
    ...
    this.onDocumentPointerUp = function (pev) {
      var _a = _this; var calendar = _a.calendar; var documentPointer = _a.documentPointer
...
var ExternalElementDragging = /** @class */ (function () {
  function ExternalElementDragging (dragging, suppliedDragMeta) {
    ...
    this.handleDragEnd = function (pev) {
      var _a = _this; var receivingCalendar = _a.receivingCalendar; var droppableEvent = _a.droppableEvent
      _this.clearDrag()
...
var ExternalDraggable = /** @class */ (function () {
  function ExternalDraggable (el, settings) {
    ...
    this.handlePointerDown = function (ev) {
      var dragging = _this.dragging
      var _a = _this.settings; var minDistance = _a.minDistance; var longPressDelay = _a.longPressDelay
