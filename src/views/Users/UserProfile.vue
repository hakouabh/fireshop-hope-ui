        ...
        <div class="row">
                  ...
                  <div class="card-body">
                     <div class="d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <tab-nav :pills="true" id="profile-pills-tab" class="d-flex mb-0 text-center profile-tab" data-toggle="slider-tab" role="tablist">
                           <tab-nav-items :active="true" id="pills-feed-tab" href="#profile-feed"  role="tab" dataToggle="tab" :ariaSelected="false">
                              <template v-slot:title>
                                    Feed
                              </template>
                           </tab-nav-items>
                           <tab-nav-items :active="false" id="pills-activity-tab" href="#profile-activity"  role="tab" dataToggle="tab" :ariaSelected="false">
                              <template v-slot:title>
                                    Activity
                              </template>
                           </tab-nav-items>
                           <tab-nav-items :active="false" id="pills-friends-tab" href="#profile-friends" ariaControls="profile-friends" role="tab" dataToggle="tab" :ariaSelected="false">
                              <template v-slot:title>
                                    Friends
                              </template>
                           </tab-nav-items>
               ...
               <div class="card-body">
                  <div class="twit-feed">
                     <div class="d-flex align-items-center mb-2">
                        <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-danger ps-2" src="@/assets/images/icons/03.png" alt="">
                  ...
                  <div class="twit-feed">
                     <div class="d-flex align-items-center mb-2">
                        <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-primary" src="@/assets/images/icons/04.png" alt="">
                        <div class="media-support-info">
                  ...
                  <div class="twit-feed">
                     <div class="d-flex align-items-center mb-2">
                           <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-warning pt-2" src="@/assets/images/icons/02.png" alt="">
                        <div class="mt-2">
          ...
          <div class="col-lg-6">
            <tab-content extraclass="profile-content">
               <tab-content-item id="profile-feed" :active="true">
                  <div class="card">
                        ...
                        <div class="comment-area p-3">
                           <div class="d-flex flex-wrap justify-content-between align-items-center">
                              ...
                              <div class="share-block d-flex align-items-center feather-icon">
                               ...
                               <offcanvas mainClass="bottom share-offcanvas" :tabindex="-1" id="share-btn" ariaLabelled="shareBottomLabel">
                                 <offcanvas-header>
               ...
               <tab-content-item id="profile-activity" :active="false">
                  <div class="card">
               ...
               <tab-content-item id="profile-friends" :active="false">
                  <div class="card">
                     <div class="card-header">
                        <div class="header-title">
          ...
          <div class="col-lg-3">
             ...
             <div class="card">
               ...
               <div class="card-body">
                  <ul class="list-inline m-0 p-0">
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-warning rounded-pill"><img src="@/assets/images/icons/05.png" alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Paul Molive</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-danger rounded-pill"><img src="@/assets/images/icons/03.png" alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Robert Fox</h6>
                           <p class="mb-0">4 mutual friends</p>
                        </div>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-dark rounded-pill"><img src="@/assets/images/icons/06.png" alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Jenny Wilson</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-primary rounded-pill"><img src="@/assets/images/icons/07.png" alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Cody Fisher</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-info rounded-pill"><img src="@/assets/images/icons/04.png" alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Bessie Cooper</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-warning rounded-pill"><img src="@/assets/images/icons/02.png" alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Wade Warren</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-success rounded-pill"><img src="@/assets/images/icons/01.png" alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Guy Hawkins</h6>
                     ...
                     <li class="d-flex align-items-center">
                        <div class="img-fluid bg-soft-info rounded-pill"><img src="@/assets/images/icons/08.png" alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Floyd Miles</h6>
